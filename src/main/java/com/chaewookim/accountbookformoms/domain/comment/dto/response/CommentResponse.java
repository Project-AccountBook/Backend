...
public record CommentResponse(
    ...
    public static CommentResponse from(Comment comment) {
        return from(comment, null, 0L, false, "NONE");
    }

    public static CommentResponse from(Comment comment, String authorNickname) {
        return from(comment, authorNickname, 0L, false, "NONE");
    }

    public static CommentResponse from(Comment comment, String authorNickname, long likeCount, boolean liked, String authorRole) {
        return from(comment, authorNickname, likeCount, liked, authorRole, null);
    }

    public static CommentResponse from(Comment comment, String authorNickname, long likeCount, boolean liked, String authorRole, String overrideContent) {
