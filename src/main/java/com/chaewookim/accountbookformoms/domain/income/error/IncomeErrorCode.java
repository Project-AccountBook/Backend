package com.chaewookim.accountbookformoms.domain.income.error;
...
public enum IncomeErrorCode implements BaseErrorCode {
    ...
    TARGET_NOT_PUBLIC(HttpStatus.FORBIDDEN, "비공개 사용자의 수입은 조회할 수 없습니다.");
