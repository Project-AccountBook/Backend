...
public class CategoryService {
    ...
    public void deleteCategory(Long categoryId, Long userId) {
        ...
        fixedTransactionRepository.softDeleteByTransactionCategoryId(categoryId);

        transactionRepository.backfillCategorySnapshot(categoryId, categoryName);
        transactionRepository.markCategoryArchived(categoryId);
        budgetRepository.backfillCategorySnapshot(categoryId, categoryName);
        budgetRepository.markCategoryArchived(categoryId);
